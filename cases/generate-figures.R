...
ggsave(paste0(fig_folder, "/le_baselines.pdf"),le_baselines, width = 1.3*width, height=1.3*width)
...
ggsave(paste0(fig_folder, "/g1_joint.pdf"),g1_joint, width = width, height=1.2*width)
ggsave(paste0(fig_folder, "/g2_comp.pdf"),gg2_comp, width = width, height=1.2*width)
ggsave(paste0(fig_folder, "/g1_comp_joint.pdf"),g1_comp_joint, width = width, height=1.2*width)
